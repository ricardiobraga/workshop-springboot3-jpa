package com.projetoweb.projetowebspringboot.config;
...
import com.projetoweb.projetowebspringboot.entities.Payment;
...
import com.projetoweb.projetowebspringboot.repositories.OrderItemRepository;
...
import com.projetoweb.projetowebspringboot.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        categoryRepositoty.saveAll(Arrays.asList(cat1, cat2, cat3));
        productRepositoty.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
